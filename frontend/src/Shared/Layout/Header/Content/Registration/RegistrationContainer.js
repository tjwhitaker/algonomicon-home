...
const RegistrationContainer = ({ RegistrationStore }) => (
  <SubscribeContainer>
    <InputContainer>
      ...
      <Input type="email" value={RegistrationStore.email} onInput={RegistrationStore.handleChange} placeholder="example@algonomicon.com" />
    </InputContainer>
    <Button onclick={RegistrationStore.handleSubmit}>Sign Up!</Button>
  </SubscribeContainer>
)
