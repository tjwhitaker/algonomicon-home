...
//   <Showcase>
//     <Subtitle>Welcome to The Open Source Machine Learning Community!</Subtitle>

//     <Paragraph>Thanks to increased computational power and vast amounts of data, machine learning models are capable of solving problems previously thought to be impossible. Machine Learning applications are powering self driving cars, searching for life beyond the stars, and finding subatomic particles in the Large Hadron Collider. Machine learning has the power to do a lot of good and we plan to use this power to work on some of the grand challenges that humanity faces.</Paragraph>
...
//     <Paragraph>We're particularly interested in the following research topics:</Paragraph>
...
//     <Paragraph>If you own or work at a company that is tackling global or social issues, we'd love to get in touch. Feel free to visit our <a href="/contact">contact page</a> or reach out directly to info@algonomicon.com.</Paragraph>

//     <Paragraph>We support open source software. If you like our content, please join our mission and collaborate with us on <a href="https://github.com/algonomicon">Github</a>.</Paragraph>
//   </Showcase>
// )
...
export const MainContainer = () => (
  <div {...mainStyles}>
    <h2>Welcome to The Open Source Machine Learning Community!</h2>
