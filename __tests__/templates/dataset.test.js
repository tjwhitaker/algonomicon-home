            ...
            children: [
              {
                ...
                marks: [],
                text:
                  "The MNIST dataset is a collection of images of handwritten digits. Each image is greyscale, centered and sized to 28x28 pixels. The original dataset (",
              },
              {
                _key: "d600a1dfb78b1",
                _type: "span",
              ...
              },
              {
                ...
                marks: [],
                text:
                  ") is provided as a custom format of bytes. The files we provide here are processed, formatted and converted to csv in order to make it easier to use.",
              },
            ],
            markDefs: [
              {
            ...
            children: [
              {
                ...
                marks: [],
                text:
                  "Images: 60,000/10,000 (train/test) instances where each instance is seperated by a newline. Each row is a series of 784 (28x28) comma-separated floats which represent pixel values. Each pixel has a value between 0 and 1, corresponding to the intensity of the brightness, where 0 is black and 1 is white.",
              },
            ],
            markDefs: [],
            style: "normal",
            ...
            children: [
              {
                ...
                marks: [],
                text:
                  "Labels: 60,000/10,000 (train/test) instances corresponding to the images csv. Each instance is seperated by a newline and each contains a digit from 0 to 9.",
              },
            ],
            markDefs: [],
            style: "normal",
